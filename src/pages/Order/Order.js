...
export default class Order extends Component {
      ...
      catalog: [
        {
          ...
          title: "De la casa",
          description:
            "2 Pizzas familiares: Pepperoni y Solo queso + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 13990,
            id: "CMB0",
        ...
        },
        {
          ...
          title: "1",
          description:
            "1 Pizza familiar de la casa + 1 Porción de palitos tropicales + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 14990,
            id: "CMB1",
        ...
        },
        {
          ...
          title: "2",
          description:
            "1 Pizzas familiar (pollo bbq) + 1 Pizza mediana (napolitana) + Palitos de ajo + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 19490,
            id: "CMB2",
        ...
        },
        {
          ...
          title: "3",
          description:
            "1 Pizza pollo champiñón + 1 Pizza italiana + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 19490,
            id: "CMB3",
        ...
        },
        {
          ...
          title: "4",
          description:
            "2 Pizzas familiares: Montañera y Hawaiana + Palitos de ajo + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 23990,
            id: "CMB4",
        ...
        },
        {
          ...
          title: "5",
          description:
            "2 Pizzas familiares (con 3 ingredientes a elección por pizza) + Bebida 1.5lts",
          size: {
            size: "FAM",
            price: 21990,
            id: "CMB5",
        ...
        },
        {
          ...
          title: "Vegetariana",
          description:
            "Mozzarella, tomate, pimentón verde y rojo, choclo y champiñón",
          size: {
            size: "MED",
            price: 7990,
            id: "REM9",
        ...
        },
        {
          ...
          title: "Vegana",
          description:
            "Queso vegano, pimentón verde y rojo, choclo, aceituna y tomate",
          size: {
            size: "MED",
            price: 8990,
            id: "REM10",
        ...
        },
        {
          ...
          title: "Lomo pizza",
          description:
            "Mozzarella, tomate, churrasco, lechuga, huevos omelette, orégano, aceituna, pimentón rojo.",
          size: {
            price: 18000,
            id: "REM11",
            selectedIndicator: "",
        ...
        },
        {
          ...
          description:
            "Pasta, salsa bechamel, piña, pollo, jamón, choclo y queso",
          size: {
            price: 5490,
            id: "LAG0",
            selectedIndicator: "",
        ...
        {
          photo: "https://www.dropbox.com/s/4mwe6whauhhp6h0/REM12.png?raw=1",
          title: "Combo Filichi",
          description:
            "Pimiento, cebolla, caramelizada, queso + Papas fritas + Bebida en lata 350ml",
          size: {
            price: 8490,
            id: "HCMB0",
            selectedIndicator: "",
        ...
        {
          photo: "https://www.dropbox.com/s/xbtegohjlcrlc41/REM13.png?raw=1",
          title: "Combo Pollo Capre",
          description:
            "Pollo, tomate cherry, albahaca, queso + Papas fritas + Bebida en lata 350ml",
          size: {
            price: 8490,
            id: "HCMB1",
            selectedIndicator: "",
            isSelected: false,
            name: "Combo Pollo Capre",
          },
          isCombo: true,
        },
        {
          photo: "https://www.dropbox.com/s/stb094ow2utcnvs/REM14.png?raw=1",
          title: "Combo Chacarero",
          description:
            "Carne, poroto verde, tomate, ají + Papas fritas + Bebida en lata 350ml",
          size: {
            price: 8490,
            id: "HCMB2",
            selectedIndicator: "",
            isSelected: false,
            name: "Combo Chacarero",
          },
          isCombo: true,
        },
        {
          photo: "https://www.dropbox.com/s/2kjlrc6w3ryr1zs/REM15.png?raw=1",
          title: "Combo Lomo Italiano",
          description:
            "Lomito, tomate, palta, mayonesa + Papas fritas + Bebida en lata 350ml",
          size: {
            price: 8490,
            id: "HCMB3",
            selectedIndicator: "",
            isSelected: false,
            name: "Combo Lomo Italiano",
          },
          isCombo: true,
        },
        {
          photo: "https://www.dropbox.com/s/pkdit5vxifttd1n/REM16.png?raw=1",
          title: "Combo Ave Italiano",
          description:
            "Pollo, tomate, palta, mayonesa + Papas fritas + Bebida en lata 350ml",
          size: {
            price: 8490,
            id: "HCMB4",
            selectedIndicator: "",
            isSelected: false,
            name: "Combo Ave Italiano",
          },
          isCombo: true,
        },
        {
          photo: "https://www.dropbox.com/s/zr5bqzyvnsene9m/REM17.png?raw=1",
          title: "Papas fritas",
          description: "Servicio de papas fritas",
          size: {
            price: 3490,
            id: "PF1",
            selectedIndicator: "",
  ...
  orderSummary = () => {
    this.setState({
      order: [
        ...
        this.state.extraSelected,
        this.state.refreshmentSelected,
      ],
    });
  };
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevState.catalogSelected !== catalogSelected ||
      prevState.extraSelected !== extraSelected ||
      prevState.refreshmentSelected !== refreshmentSelected
    ) {
      this.orderSummary();
    }
  }
  ...
  render() {
    ...
    totalSumary = productsSummary.reduce(
        ...
        <div className="order">
            ...
            <div className="tabs-link">
              <Link to="#extras">
                <ButtonSecondary
                  isSubject="secondary"
                  isText="Extras"
                  isIcon={<Icon faIcon={faCookieBite} />}
                />
              </Link>
          ...
          <div className="order__catalog-selector">
            <div className="order__catalog">
              {catalog.map((item, index) => {
                return (
                  <div
                    key={index}
                    className={`order__catalog-item ${item.size.selectedIndicator}`}
                    id={item.size.id}
                    onClick={this.selectSizeHandler(index)}
                  >
            ...
            <div className="order__extra" id="extras">
              <div className="order__extra-title">
              ...
              <div className="order__extra-items">
                {extras.map((extra, index) => {
                  return (
                    <div
                      key={index}
                      className={"order__extra-item " + extra.selectedIndicator}
                      onClick={this.selectExtras(index)}
                    >
            ...
            <div className="order__refreshments" id="refreshments">
              <div className="order__refreshments-title">
                ...
                {refreshments.map((refreshment, index) => {
                  return (
                    <div
                      key={index}
                      className={
                        "order__extra-item " + refreshment.selectedIndicator
                      }
                      onClick={this.selectRefreshment(index)}
                    >
                      <div className="item-name">
                        {refreshment.isSelected ? (
                          <Icon faIcon={faTrashAlt} />
                        ) : (
                          ""
                        )}
          ...
          <div className="order__action">
            <div className="order__total">
              ...
              <small>
                El precio de delivery será agragado una vez continues con tu
                pedido
              </small>
            </div>
            {totalSumary === 0 ? (
              <div className="order__submit--disable">
                <ButtonMain
                  isSubject="unactive"
                  isText="Selecciona algún producto"
          ...
          >
            <div className="modal__header">
              <div className="modal-title">
                ...
                <strong>Información de tu pedido</strong>
              </div>
              ...
              <div className="order-cost">
                <div className="modal-product">
                  ...
                  <span className="product-msg">
                    {deliveryCost}
                    <span onClick={this.noCostToggel}>
                      <Icon faIcon={faArrowAltCircleDown} />
                    </span>
                  </span>
                  <ul
                    className={
                  ...
                  >
                    {deliveryNoCost.map((item, id) => {
                      return (
                        <li key={id.id} className="dropdown-list-item">
                          {item.province}
                        </li>
                      );
                    })}
