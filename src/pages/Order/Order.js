...
import { faPizzaSlice, faTrashAlt, faStar, faBicycle, faThumbsUp, faHandPointUp, faUtensils, faClipboardList, faTimes } from '@fortawesome/free-solid-svg-icons'
...
export default class Order extends Component {
    ...
    this.state = {
      catalog: [
        ...
        },
        {
          ...
          size: { size: 'M', price: 7990, id: 'RRM2', selectedIndicator: '', isSelected: false, name: 'Pollo champiñón' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'Pollo champiñón',
          description: 'Mozzarella, pollo y champiñón',
          size: { size: 'XL', price: 12990, id: 'RREX2', selectedIndicator: '', isSelected: false, name: 'Pollo champiñón' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          size: { size: 'M', price: 7990, id: 'RRM4', selectedIndicator: '', isSelected: false, name: 'BBQ' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'BBQ',
          description: 'Mozzarella, pollo, tocino, cebolla, base BBQ',
          size: { size: 'XL', price: 12490, id: 'RREX4', selectedIndicator: '', isSelected: false, name: 'BBQ' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          size: { size: 'M', price: 6990, id: 'RRM6', selectedIndicator: '', isSelected: false, name: 'Napolitana' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'Napolitana',
          description: 'Mozzarella, tomate y orégano',
          size: { size: 'XL', price: 10490, id: 'RREX6', selectedIndicator: '', isSelected: false, name: 'Napolitana' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
          ...
          size: { size: 'M', price: 4990, id: 'RRM7', selectedIndicator: '', isSelected: false, name: 'Pepperoni' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'Pepperoni',
          description: 'Extra mozzarella y pepperoni',
          size: { size: 'XL', price: 10490, id: 'RREX7', selectedIndicator: '', isSelected: false, name: 'Pepperoni' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
          ...
          size: { size: 'M', price: 4990, id: 'RREM8', selectedIndicator: '', isSelected: false, name: 'Solo queso' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'Solo queso',
          description: 'Extra de mozzarella',
          size: { size: 'XL', price: 8990, id: 'RREX8', selectedIndicator: '', isSelected: false, name: 'Solo queso' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
          ...
          size: { size: 'M', price: 7990, id: 'RRM9', selectedIndicator: '', isSelected: false, name: 'Vegetariana' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
        ...
        },
        {
          ...
          title: 'Vegetariana',
          description: 'Mozzarella, tomate, pimentón verde, choclo y champiñón',
          size: { size: 'XL', price: 12990, id: 'RREX9', selectedIndicator: '', isSelected: false, name: 'Vegetariana' },
          isCombo: false
        },
        {
          photo: 'https://www.fillmurray.com/164/168',
  ...
  render() {
    ...
    return (
      <Wrapper>
        <div className="order">
          <div className="order__header"><Icon faIcon={faUtensils} /><strong>Arma tu pedido</strong></div>
          <div className="order__catalog-selector">
            <div className="order__catalog">
              {catalog.map((item, index) => {
                return (
                  <div key={index} className="order__catalog-item" id={item.size.id} onClick={this.selectSizeHandler(index)}>
                      ...
                      <div className="order__catalog-item-sizes">
                        <div className="order__catalog-item-size">
                          <div className="size-price">
                            <div className={"size-item " + item.size.selectedIndicator}>
            ...
            <div className="order__refreshments">
              <div className="order__refreshments-title"><strong>Bebidas</strong></div>
              <div className="order__refreshments-items">
                {refreshments.map((refreshment, index) => {
                  return (
                    <div key={index} className={"order__refreshments-item " + refreshment.selectedIndicator} onClick={this.selectRefreshment(index)}>
